        ...
        onCompleted: (response) => {
            ...
            const formValues: PartialFormValues = removeNull({
                ...
                figures: entry.figures?.map((figure) => ({
                    ...
                    term: figure.term,
                    violence: figure.violence?.name,
                    violenceSubType: figure.violenceSubType?.name,
                    figureCause: figure.figureCause,
                    contextOfViolence: figure.contextOfViolence?.map((c) => c.id),
                    disasterType: figure.disasterType?.name,
                    disasterSubType: figure.disasterSubType?.name,
                    disasterCategory: figure.disasterCategory?.name,
                    disasterSubCategory: figure.disasterSubCategory?.name,
                    osvSubType: figure.osvSubType?.name,
