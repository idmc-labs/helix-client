        ...
        extractionEntryList(
            ...
            results {
                ...
                totalStockIdpFigures(data: {
                    ...
                    regions: $filterFigureRegions,
                    categories: $filterFigureCategories,
                    endBefore: $filterFigureEndBefore,
                    roles: $filterFigureRoles,
                    terms: $filterFigureTerms,
                    geographicalGroups: $filterFigureGeographicalGroups,
                    categoryTypes: $filterFigureCategoryTypes,
                    sexTypes: $filterFigureSexTypes,
                    displacementTypes: $filterFigureDisplacementTypes,
                }),
