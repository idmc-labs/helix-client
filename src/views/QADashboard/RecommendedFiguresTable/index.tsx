...
function RecommendedFiguresTable(props: tableProps) {
    const {
        className,
        crisis,
    } = props;
    ...
    return (
        <div className={_cs(styles.events, className)}>
            ...
            <Container
                ...
                heading="Events with Recommended Figures"
                footerContent={(
                    <Pager
                        activePage={page}
...
export default RecommendedFiguresTable;
