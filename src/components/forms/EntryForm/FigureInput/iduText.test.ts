...
const cases: Case[] = [
    ...
    { n: 13, input: { ...base, term: 'DESTROYED_HOUSING', unit: 'PERSON', reported: 4, quantifier: 'MORE_THAN_OR_EQUAL', geoLocations: [geo('ORIGIN', 'Kathmandu, Nepal')], ...disaster('1'), sources: [], startDate: '2025-04-25' }, expected: 'According to reported sources, the housing of at least four people were destroyed in Kathmandu due to an earthquake on April 25, 2025.' },
    ...
    { n: 15, input: { ...base, term: 'PARTIALLY_DESTROYED_HOUSING', unit: 'PERSON', reported: 210, quantifier: 'APPROXIMATELY', geoLocations: [geo('ORIGIN', 'Freetown, Sierra Leone')], ...disaster('15'), sources: media, startDate: '2024-08-14', endDate: '2025-01-10' }, expected: 'According to media sources, the housing of around 210 people were partially destroyed in Freetown due to a landslide between August 2024 and January 2025.' },
